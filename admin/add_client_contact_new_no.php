...
<head>
    ...
    <title>Contact Person New Number - <?php echo $client_name; ?></title>
	            ...
	            <div class="row">
	                <div class="col-md-12 page_links">
	                    ...
	                    <ol class="breadcrumb">
	                        ...
	                        <li><i class="fa fa-building"></i><a href="clients_update_info.php"><?php echo $client_name; ?></a></li>
	                        <li><i class="icon_document"></i><a href="add_client_contact_new_no.php">Update Info</a></li>
...
?>										
								...
								<div class="form-group">
									<div class="col-md-offset-6 col-md-6">
										...
										<a href="clients_update_info.php" class="btn btn-default"><strong>Cancel</strong></a>
