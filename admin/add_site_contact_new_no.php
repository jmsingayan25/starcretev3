...
<?php
    ...
    if(isset($_SESSION['post_site_contact_id'])){
    	$post_site_contact_id = $_SESSION['post_site_contact_id'];
    }
    ...
    $contact = getSiteContactInfo($db, $post_site_contact_id);
    $site_contact_id = $contact['site_contact_person_id'];
...
<head>
    ...
    <title>Contact Person New Number - <?php echo $site_name; ?></title>
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-file-text"></i><a href="add_site_contact_new_no.php">Update Info</a></li>                            
                            <li><i class="fa fa-file-text"></i>New No.</li>                            
                        </ol>
                    </div>
                </div>

                <form class="form-horizontal" role="form" action="add_site_contact_new_no.php" id="form" method="post" onsubmit="return confirm('Proceed?');">
                <div class="row">
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label for="site_name" class="col-md-5 control-label">Contact Name</label>
                                    <div class="col-md-5">
                                        <p class="help-block"><strong><?php echo $site_contact_name; ?></strong></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="contact_no" class="col-md-5 control-label">Contact No.</label>
                                    <div class="col-md-5">
<?php 

    $sql = "SELECT * FROM site_contact_number WHERE site_contact_person_id = '$site_contact_id'";
...
?>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p class="help-block">
                                                    <strong><?php echo $row_sql_result['site_contact_no']; ?></strong>
                                                </p>
                                            </div>
                                        </div>
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        for ($i=0; $i < count($contact_no); $i++) { 
            ...
            $insert_contact_no = "INSERT INTO site_contact_number(site_contact_no, site_contact_person_id) 
                                    VALUES('$contact_no[$i]','$site_contact_id')";
