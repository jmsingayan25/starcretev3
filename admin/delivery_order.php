        ...
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    <h3 class="page-header"><a href="delivery_order.php?office=<?php echo $search_plant ?>"><?php echo $plant; ?> Delivery Order</a></h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-building"></i><?php echo $plant; ?></li>
                        <li><i class="icon_document"></i><a href="delivery_order.php?office=<?php echo $search_plant ?>" style="color: blue;">Ongoing Delivery <span class="badge"><?php echo getDeliveryCountOnDeliveryOffice($db, $search_plant); ?></span></a></li>
