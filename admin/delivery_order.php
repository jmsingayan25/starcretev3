...
?>
                            <li class="notif">
                                <a href="delivery_order.php?table_name=<?php echo $notif_sql_row['table_name']; ?>&from_office=<?php echo $notif_sql_row['from_office']; ?>&post_dr_no=<?php echo $notif_sql_row['content']; ?>"><?php echo $detail; ?></a>
                            </li>
<?php
            $notif_count++;
        }                            
        ...
        <section class="wrapper">      
            ...
            <div class="row">
                <div class="col-lg-12 page_links">
                    <h3 class="page-header"><a href="delivery_order.php?office=<?php echo $search_plant ?>" style="color: inherit;"><?php echo $plant; ?> Delivery Order</a></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="icon_document"></i>Ongoing Delivery <span class="badge"><?php echo getDeliveryCountOnDeliveryOffice($db, $search_plant); ?></span></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <form action="delivery_order.php" method="get" class="form-inline">
...
<?php
    ...
    $query = "SELECT d.delivery_id, d.delivery_receipt_no, d.item_no, d.quantity, d.gate_pass, d.po_no_delivery, DATE_FORMAT(d.date_delivery,'%m/%d/%y') as date_delivery , d.office, d.remarks, d.fk_po_id, s.site_name, s.site_address, c.client_name, GROUP_CONCAT(DISTINCT p.site_contact_person_id SEPARATOR ', ') as site_contact_person_id, d.psi, d.fk_unique_po_id
...
?>
            <tr>
                <td><?php echo $hash; ?></td>
                <td id="<?php echo $row['delivery_receipt_no']; ?>"><strong><?php echo $row['delivery_receipt_no']; ?></strong></td>
