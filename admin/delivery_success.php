    ...
    <section id="main-content">
        <section class="wrapper">            
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <form action="delivery_success.php" method="get" class="form-inline">
...
<?php
    if(isset($_GET['search_table'])){
        ...
        $adjacents = 3;
        $targetpage = "delivery_success.php"; //your file name
        $page = $_GET['page'];
        ...
        if($lastpage > 1){ 
            ...
            if ($page > $counter+1) {
                $pagination.= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=$prev&start_date=$start_date&end_date=$end_date&search=$search_word&view_count=$limit&search=$search_word&view_count=$limit\">Previous</a></li>"; 
            }
        ...
        $query = "SELECT d.delivery_id, d.delivery_receipt_no, d.item_no, d.quantity, d.gate_pass, d.po_no_delivery, DATE_FORMAT(d.date_delivery,'%m/%d/%y') as date_delivery1 , d.office, d.remarks, d.fk_po_id, s.site_name, s.site_address, GROUP_CONCAT(DISTINCT p.site_contact_name ORDER BY p.site_contact_name ASC SEPARATOR ', ') as site_contact_name, c.client_name, d.psi
...
?>  
                <tr>
                    ...
                    <td style="cursor: pointer;">
                        <div class="tooltips" data-original-title="Click for more details about P.O. No. <?php echo $row['po_no_delivery'] ?>" data-placement="top" onclick="window.location='delivery_po_details.php?fk_po_id=<?php echo $row['fk_po_id']; ?>&po_no_delivery=<?php echo $row['po_no_delivery']; ?>&office=<?php echo $search_plant; ?>'">
...
?>
                            <tr>        
                                <td colspan="10" style='height: 100%; background: white; border: none; text-align:center; 
