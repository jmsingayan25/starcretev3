...
<head>
    ...
    <title>Cancelled P.O. - Purchase Order</title>
            ...
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        ...
                        <ol class="breadcrumb">
                            <li><i class="fa fa-building"></i><?php echo $plant ?></a></li>
                            <li><i class="icon_document"></i><a href="purchase_order.php?office=<?php echo $search_plant; ?>">Pending P.O.</a></li>
                            <li><i class="icon_document"></i><a href="purchase_cancelled_order.php?office=<?php echo $search_plant; ?>" style="color: blue;">Cancelled P.O.</a></li>   
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <form action="purchase_cancelled_order.php" method="get" class="form-inline">
...
<?php
    if(isset($_GET['search_table'])){
        ...
        $adjacents = 3;
        $targetpage = "purchase_cancelled_order.php"; //your file name
        $page = $_GET['page'];
