...
<?php
    ...
    $adjacents = 3;
    $targetpage = "purchase_closed_order.php"; //your file name
    $page = $_GET['page'];
    ...
    // $query = "SELECT o.purchase_id, o.purchase_order_no, o.item_no, o.quantity, o.delivered, o.backload, o.balance, o.cancelled, o.office, o.remarks, l.unit, s.site_name, s.site_address, GROUP_CONCAT(DISTINCT p.site_contact_name ORDER BY p.site_contact_name ASC SEPARATOR ', ') as site_contact_name, DATE_FORMAT(o.date_closed,'%m/%d/%y') as date_closed, DATE_FORMAT(o.date_purchase,'%m/%d/%y') as date_purchase, o.psi, d.reason
    //             FROM purchase_order_ d, purchase_order o, batch_list l, site_contact_person p, site s, purchase_order_contact c
                // ".$string." ".$string_date."
                // AND d.purchase_order_id = o.purchase_id
                // AND o.purchase_id = c.purchase_id
                // AND c.site_contact_id = p.site_contact_person_id
                ...
                // ORDER BY date_closed DESC LIMIT $start, $limit";
