...
<head>
    ...
    <title>Delivered P.O. - Purchase Order</title>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url: 'purchase_deliver_order.php',
            method: get,
            data:{
                var1 : val1
            },
            ...
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        <h3 class="page-header"><a href="purchase_deliver_order.php?office=<?php echo $search_plant; ?>"><?php echo $plant; ?> Purchase Order</a></h3>
                        <ol class="breadcrumb">
                            ...
                            <li><i class="icon_document"></i><a href="purchase_deliver_order.php?office=<?php echo $search_plant; ?>" style="color: blue;">Delivered P.O.</a></li>                            
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <form action="purchase_deliver_order.php" method="get" class="form-inline">
...
<?php
    ...
    $adjacents = 3;
    $targetpage = "purchase_deliver_order.php"; //your file name
    $page = $_GET['page'];
    ...
    $query = "SELECT o.purchase_id, o.purchase_order_no, o.item_no, o.quantity, o.delivered, o.backload, o.balance, o.cancelled, o.office, o.remarks, l.unit, s.site_name, s.site_address, GROUP_CONCAT(DISTINCT p.site_contact_name ORDER BY p.site_contact_name ASC SEPARATOR ', ') as site_contact_name, DATE_FORMAT(o.date_purchase,'%m/%d/%y') as date_purchase, DATE_FORMAT(o.date_delivered,'%m/%d/%y') as date_delivered1, o.psi
                ...
                AND delivered > 0
                GROUP BY o.purchase_id
                ORDER BY date_delivered1 DESC LIMIT $start, $limit";
// echo $query;
...
?>
            <tr>
                ...
                <td><strong><?php echo number_format((float)$row['delivered'])." pcs"; ?></strong></td>
...
?>
                ...
                <td><strong><?php echo $row['date_delivered1']; ?></strong></td>
            </tr>
<?php
            $hash++;
        }
