            ...
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        <h3 class="page-header"><a href="received.php?office=<?php echo $search_plant; ?>"><?php echo $plant; ?> Received Deliveries</a></h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-building"></i><?php echo $plant; ?></li>
                            <li><i class="fa fa-address-book"></i><a href="received.php" style="color: blue;">Received Deliveries</a></li>
                            <li><i class="fa fa-address-book"></i><a href="received_pending.php">Pending Deliveries</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <form action="received.php" method="get" class="form-inline">
...
<?php
    ...
    if(isset($_GET['search_table'])){
        ...
        $adjacents = 3;
        $targetpage = "received.php"; //your file name
        $page = $_GET['page'];
        ...
        $query = "SELECT r.po_aggregates_no_received, r.item_no, r.quantity, r.delivery_no_received, r.truck_no, r.volume,0, l.unit, r.supplier_name, DATE_FORMAT(r.date_po_aggregates,'%m/%d/%y') as date_po_aggregates1, r.office, remarks
