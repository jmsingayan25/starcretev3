                ...
                <ul class="sidebar-menu">                
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <!-- <li><a class="" href="received.php?office=bravo">Received Page</a></li> -->
                        </ul>
                    </li>  
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                        ...
                        <ul class="sub">
                            ...
                            <!-- <li><a class="" href="received.php?office=delta">Received Page</a></li> -->
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
            ...
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        <h3 class="page-header"><a href="received.php?office=<?php echo $search_plant; ?>"><?php echo $plant; ?> Pending Deliveries</a></h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-building"></i><?php echo $plant; ?></li>
                            <li><i class="fa fa-address-book"></i><a href="received.php">Received Deliveries</a></li>
                            <li><i class="fa fa-address-book"></i><a href="received_pending.php" style="color: blue;">Pending Deliveries</a></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <form action="received_pending.php" method="get" class="form-inline">
