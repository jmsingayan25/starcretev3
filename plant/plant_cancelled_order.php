	        ...
	        <section class="wrapper">            
	            ...
	            <div class="row">
	                <div class="col-lg-12 page_links">
	                    <!-- <h3 class="page-header"><i class="icon_document"></i><a href="plant_cancelled_order">Cancelled Order</a></h3> -->
	                    <ol class="breadcrumb">
	                        <li><i class="fa fa-building"></i>Purchase Order</li>
                            <li><i class="icon_document"></i><a href="plant_cancelled_order.php" style="color: blue;">Cancelled P.O.</a></li>						  	
	                    </ol>
	                </div>
	            </div>
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	                    <section class="panel">
	                        <form action="plant_cancelled_order.php" method="get" class="form-inline">
...
<?php
    ...
    $adjacents = 3;
    $targetpage = "plant_cancelled_order.php"; //your file name
    $page = $_GET['page'];
    ...
    $query = "SELECT o.purchase_id, o.purchase_order_no, o.item_no, o.quantity, o.delivered, o.backload, o.balance, o.cancelled, o.office, o.remarks, l.unit, s.site_name, s.site_address, GROUP_CONCAT(DISTINCT p.site_contact_name ORDER BY p.site_contact_name ASC SEPARATOR ', ') as site_contact_name, DATE_FORMAT(o.date_purchase,'%m/%d/%y') as date_purchase, DATE_FORMAT(o.date_cancelled,'%m/%d/%y') as date_cancelled, o.psi 
...
?>
            <tr>
                ...
                <td><strong><?php echo number_format((float)$row['cancelled'])." pcs"; ?></strong></td>
