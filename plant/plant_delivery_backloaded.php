...
<head>
    ...
    <title>Backloaded - Delivery Order</title>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url: 'plant_delivery_backloaded.php',
            method: get,
            data:{
                var1 : val1
            },
	    ...
	    <section id="main-content">
	        <section class="wrapper">            
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	                    <section class="panel">
	                        <form action="plant_delivery_backloaded.php" method="get" class="form-inline">
...
<?php
	...
	$adjacents = 3;
	$targetpage = "plant_delivery_backload.php"; //your file name
	$page = $_GET['page'];
	...
	$query = "SELECT d.delivery_id, d.delivery_receipt_no, d.item_no, d.quantity, d.gate_pass, d.po_no_delivery, DATE_FORMAT(d.date_delivery,'%m/%d/%y') as date_delivery , d.office, d.remarks, d.fk_po_id, s.site_name, s.site_address, c.client_name, GROUP_CONCAT(DISTINCT p.site_contact_name ORDER BY p.site_contact_name ASC SEPARATOR ', ') as site_contact_name, d.psi, d.fk_unique_po_id
                ...
                AND s.site_id = p.site_id ".$string_ext."
                AND remarks = 'Backload' 
