	        ...
	        <section class="wrapper">            
	            ...
	            <div class="row">
	                <div class="col-lg-12 page_links">
	                    <h3 class="page-header"><a href="plant_delivery_delivered.php" style="color: inherit;">Delivered Order</a></h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
...
<?php
	...
	$sql = "SELECT * FROM delivery d, site s, site_contact_person p, purchase_order_contact pc ".$string." 
	...
	$adjacents = 3;
	$targetpage = "plant_delivery_delivered.php"; //your file name
	$page = $_GET['page'];
	...
	$query = "SELECT d.delivery_id, d.delivery_receipt_no, d.item_no, d.quantity, d.gate_pass, d.po_no_delivery, DATE_FORMAT(d.date_delivery,'%m/%d/%y') as date_delivery1 , d.office, d.remarks, d.fk_po_id, s.site_name, s.site_address, c.client_name, GROUP_CONCAT(DISTINCT p.site_contact_name ORDER BY p.site_contact_name SEPARATOR ', ') as site_contact_name, d.psi, d.fk_unique_po_id
...
?>	
			<tr>
                ...
                <td style="cursor: pointer;">
                    <div class="tooltips" data-original-title="Click for more details about P.O. No. <?php echo $row['po_no_delivery'] ?>" data-placement="top" onclick="window.location='plant_po_details.php?fk_po_id=<?php echo base64_encode($row['fk_po_id']); ?>&po_no_delivery=<?php echo $row['po_no_delivery']; ?>&fk_unique_po_id=<?php echo base64_encode($row['fk_unique_po_id']); ?>'">
