...
<head>
    ...
    <title>Pending Deliveries - Received Agg</title>
            ...
            <section class="wrapper">            
                ...
                <div class="row">
                    <div class="col-lg-12 page_links">
                        <h3 class="page-header"><a href="plant_received_pending.php" style="color: inherit;">Pending Deliveries</a></h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-building"></i>Received</li>
                            <li><i class="icon_document"></i>Pending Deliveries</li>                          
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <section class="panel">
                            <form action="plant_received_pending.php" method="get" class="form-inline">
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        ...
                                        <tr class="filters">
                                            ...
                                            <th class="col-md-1"><input type="text" class="form-control" placeholder="Supplier Name" disabled></th>
...
<?php
        ...
        $adjacents = 3;
        $targetpage = "plant_received_pending.php"; //your file name
        $page = $_GET['page'];
